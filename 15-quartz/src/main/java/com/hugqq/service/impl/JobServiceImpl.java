...
import com.hugqq.entity.domain.JobAndTrigger;
import com.hugqq.entity.form.JobForm;
import com.hugqq.mapper.JobMapper;
import com.hugqq.service.JobService;
import com.hugqq.util.JobUtil;
...
public class JobServiceImpl implements JobService {
    ...
    public void addJob(JobForm form) throws Exception {
        ...
        // 构建Job信息
        // 根据全类名获取Job实例  通过反射创建实例强转为BaseJob
