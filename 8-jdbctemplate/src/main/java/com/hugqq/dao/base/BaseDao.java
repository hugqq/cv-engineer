...
import com.hugqq.annotation.Ignore;
import com.hugqq.annotation.Pk;
import com.hugqq.annotation.Table;
import com.hugqq.constant.Constants;
...
public class BaseDao<T, P> {
    ...
    protected Integer insert(T t, Boolean ignoreNull) {
        ...
        String columns = StrUtil.join(Constants.SEPARATOR_COMMA, columnList);

        // 构造占位符
        String params = StrUtil.repeatAndJoin("?", columnList.size(), Constants.SEPARATOR_COMMA);
    ...
    protected Integer updateById(T t, P pk, Boolean ignoreNull) {
        ...
        String params = StrUtil.join(Constants.SEPARATOR_COMMA, columns);
